...
def random_number():
    ...
    generated_random_friend = list1[random_no]
    lucky_friend["text"]="Your lucky friend is "+str(generated_random_friend)

btn = Button(root, text="Add friend to the list", command= addfriend)
